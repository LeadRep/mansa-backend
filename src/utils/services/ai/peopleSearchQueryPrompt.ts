...
export const peopleSearchQueryPrompt = async (customerPref: any) => {
  const messages = [
    ...
    },
    {
      ...
      Generate search parameters in JSON format that can be used to query Apollo's people search API. Only output a valid JSON object with keys person_titles, person_seniorities only. Do not include triple backticks or extra text.
